...
- `mock-provider.test.ts` — 45 tests for the ApiProvider contract via mock implementation
...
- [Testing](.claude/docs/testing.md) — Vitest setup, 300 tests, test patterns, coverage scope
